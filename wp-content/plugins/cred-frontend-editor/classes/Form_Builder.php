...
/**
 *
 * $HeadURL: https://www.onthegosystems.com/misc_svn/crud/tags/1.3.4/classes/Form_Builder.php $
 * $LastChangedDate: 2014-11-13 13:47:19 +0000 (Thu, 13 Nov 2014) $
 * $LastChangedRevision: 28846 $
...
class CRED_Form_Builder implements CRED_Friendable, CRED_FriendableStatic
{
    ...
    */
	...
	// reference to the form submission method
        ...
        StaticClass::$_cred_container_id = (isset($_POST[StaticClass::PREFIX.'cred_container_id'])) ? $_POST[StaticClass::PREFIX.'cred_container_id'] : $post_id;
