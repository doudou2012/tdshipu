...
/**
 *
 * $HeadURL: https://www.onthegosystems.com/misc_svn/crud/tags/1.3.4/classes/CredForm.php $
 * $LastChangedDate: 2014-11-05 16:16:39 +0000 (Wed, 05 Nov 2014) $
 * $LastChangedRevision: 28578 $
    ...
    public function cred_field_shortcodes($atts) {
        ...
        if (!$taxonomy) {
            ...
            elseif (
                ...
                array_key_exists('extra_fields', $this->out_['fields'])
                && is_array($this->out_['fields']['extra_fields'])
                && in_array($field, array_keys($this->out_['fields']['extra_fields']))
            ) {
            ...
            elseif (
                ...
                && in_array($field, array_keys($this->out_['fields']['taxonomies']))
            ) {
